        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="danger" stats icon>
              ...
              <h3 className={classes.cardTitle}>{ lending.isLoading === false ? 0 : lending.list.filter((item) => item.isHistory === false).length } <small>Lượt</small></h3>
            </CardHeader>
            <CardFooter stats>
              <div className={classes.stats}>
                <Icon>chevron_right</Icon>
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="info" stats icon>
              ...
              <h3 className={classes.cardTitle}>{ lending.isLoading === false ? 0 : lending.list.filter((item) => item.isHistory === true).length } <small>Lượt</small></h3>
            </CardHeader>
            <CardFooter stats>
              <div className={classes.stats}>
              <Icon>chevron_right</Icon>
